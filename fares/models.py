...
class Stop_Area(models.Model):
    ...
    stop_id = models.ForeignKey(
        'Stop', on_delete=models.CASCADE, related_name='areas',)
...
class Leg_Rule(models.Model):
    ...
    from_area = models.ForeignKey(
        'Area', on_delete=models.CASCADE, related_name='area_to', null=True, blank=True)
    to_area = models.ForeignKey(
        'Area', on_delete=models.CASCADE,  related_name='area_from', null=True, blank=True)
    product = models.ForeignKey(
        'Product', on_delete=models.CASCADE, related_name='leg_rules', null=True, blank=True)
    leg_group = models.ForeignKey(
        'Leg_Group', on_delete=models.CASCADE, null=True, blank=True)
...
class Stop(models.Model):
    ...
    parent_station = models.ForeignKey(
        'Stop', on_delete=models.CASCADE, null=True, blank=True)
...
class Transfer_Rule(models.Model):
    from_leg_group = models.ForeignKey(
        'Leg_Group', on_delete=models.CASCADE, related_name='transfer_from')
    to_leg_group = models.ForeignKey(
        'Leg_Group', on_delete=models.CASCADE, related_name='transfer_to')
